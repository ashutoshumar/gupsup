...
const TagPostCard =  ({post}:{post:PostInterface}) => {
  console.log("wow",post)
    const createdAt =new Date(post.createdAt);
    // console.log("created",createdAt,"time",createdAt,"month",createdAt.getMonth())
  ...
  //  console.log("year",ageInYear,"month",ageInMonth,"hour",ageInHour,"days",ageInDays)
    var ago=''
    if(ageInYear>=1)
    {
    ...
    {
      const varr=createdAt.toString().split(" ")
