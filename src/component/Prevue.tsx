...
import {postBlog} from "../lib/request"
import PrevueMdx from './mdx/PrevueMdx';
...
export const Prevue:FC<iProp> = async({prevue,content:source,setPrevue,errorNotify}) => {
  ...
  var today = new Date(),
    ...
    //  Send the blog post data to the server
      ...
      const res = await postBlog(metaData.title,author,tags,greyContent,userId)
