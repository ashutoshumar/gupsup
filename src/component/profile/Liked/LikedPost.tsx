...
const LikedPostsList =  () => {
  ...
  return (
    <>
    {
      ...
      { post.map((blog: PostInterface, index: number) => (
        <Card
    ...
    </div>:<div className="grid gap-4 grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 xl:grid-cols-5 mx-4 sm:mx-10">
    <NoLikeFound/>
    </div>
      )
    }
