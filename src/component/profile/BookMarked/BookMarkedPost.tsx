...
import { getAllBookMarkPosts, getTopPosts } from '@/lib/request';
import { BiSolidLike } from "react-icons/bi";
import { MdOutlineBookmark } from "react-icons/md";
import CardSkeleton from '../../CardSkeleton';
const readingTime = require('reading-time');
import { PostInterface } from '@/utility/PostInterface';
import NoBookMarkFound from './NoBookMarkFound';
const BookMarkedPostsList =  () => {
...
export default BookMarkedPostsList;
