...
import { postAddThread } from '@/lib/request';
...
export const AddThreadPrevue:FC<iProp> = async({prevue,content:source,setPrevue,errorNotify,threadId}) => {
  ...
  var today = new Date(),
    ...
    //  Send the blog post data to the server
      ...
      const res = await postAddThread(metaData.title,author,tags,greyContent,userId,threadId)
